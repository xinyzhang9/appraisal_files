...
(function (cls) {
    var PropertyViewModelBase = (function (_super) {
        ...
        function PropertyViewModelBase() {
            var _this = this;
            _super.call(this);
            this.isNumberOfUnitsGreaterThanOneForPrimaryResidence = function () {
                return _this.isSubjectProperty && _this.occupancyType == 1 /* PrimaryResidence */ && (parseInt(_this.SubjectPropertyType) == 1 /* SingleFamily */ || parseInt(_this.SubjectPropertyType) == 11 /* TownHouse */) && _this.numberOfUnits > 1;
            };
        ...
        Object.defineProperty(PropertyViewModelBase.prototype, "SubjectPropertyType", {
            get: function () {
                return !!this.attachmentType ? this.propertyType + '.' + this.attachmentType : this.propertyType;
            },
            set: function (value) {
                if (value == '0') {
                ...
                if (splittedPropertyValue.length > 1) {
                    this.propertyType = splittedPropertyValue[0];
                    this.attachmentType = Number(splittedPropertyValue[1]);
                }
                else {
                    this.propertyType = value;
                    this.attachmentType = null;
        ...
        Object.defineProperty(PropertyViewModelBase.prototype, "getCityStateZipAddress", {
            get: function () {
                return this.cityName + (this.stateName ? ", " + this.stateName : "") + " " + this.zipCode;
            },
            enumerable: true,
            configurable: true
        });
    ...
    var PropertyViewModel = (function (_super) {
        ...
        function PropertyViewModel(ti, property, homeBuyingType) {
            ...
            this.getNetRentalIncome = function () {
                if (!_this.hasTransactionInfo())
                    return null;
                if (_this.OccupancyType != 2 /* InvestmentProperty */ && !_this.isNumberOfUnitsGreaterThanOneForPrimaryResidence())
                    return null;
                if (_this.getHasTransactionalInfoIncome()) {
            ...
            */
            ...
            this.assignPropertyViewModelDefaultsForNewlyCreatedNetRentalIncome = function () {
                ...
                if (angular.isUndefined(_this.OwnershipPercentage) || _this.OwnershipPercentage == null) {
        ...
        Object.defineProperty(PropertyViewModel.prototype, "OccupancyType", {
            ...
            get: function () {
                ...
                //return this.isSubjectProperty ? this.getTransactionInfo().getLoan().getSubjectProperty().occupancyType : this.occupancyType;
            },
            set: function (occupancyType) {
                ...
                if (this.isSubjectProperty) {
                    if (occupancyType == 2 /* InvestmentProperty */ || this.isNumberOfUnitsGreaterThanOneForPrimaryResidence()) {
