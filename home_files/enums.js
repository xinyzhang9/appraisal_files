...
(function (srv) {
    ...
    //    Other = 4
    //}
    (function (NotificationEmailType) {
        NotificationEmailType[NotificationEmailType["BorrowerAcceptEConsent"] = 0] = "BorrowerAcceptEConsent";
        NotificationEmailType[NotificationEmailType["BorrowerDeclineEConsent"] = 1] = "BorrowerDeclineEConsent";
        NotificationEmailType[NotificationEmailType["BorrowerESigntITP"] = 2] = "BorrowerESigntITP";
    })(srv.NotificationEmailType || (srv.NotificationEmailType = {}));
    var NotificationEmailType = srv.NotificationEmailType;
    /**
    ...
    */
    ...
    var vaConsentName = (function () {
        function vaConsentName() {
        }
        vaConsentName.SelectOne = 'Select One';
        vaConsentName.AwareOfTheValuation = '(a) I was aware of this valuation when I signed my contract and I have paid or will pay in cash from my own resources at or prior to loan closing a sum equal to the difference between the contract purchase price or cost and the VA established value. I do not and will not have outstanding after loan closing any unpaid contractual obligation on account of such cash payment;';
        vaConsentName.NotAwareOfTheValuation = '(b) I was not aware of this valuation when I signed my contract but have elected to complete the transaction at the contract purchase price or cost. I have paid or will pay in cash from my own resources at or prior to loan closing a sum equal to the difference between contract purchase price or cost and the VA established value. I do not and will not have outstanding after loan closing any unpaid contractual obligation on account of such cash payment';
        return vaConsentName;
    })();
    srv.vaConsentName = vaConsentName;
    (function (vaConsentEnum) {
        vaConsentEnum[vaConsentEnum["SelectOne"] = 0] = "SelectOne";
        vaConsentEnum[vaConsentEnum["ReasonableValueOfTheProperty"] = 1] = "ReasonableValueOfTheProperty";
        vaConsentEnum[vaConsentEnum["AwareOfTheValuation"] = 2] = "AwareOfTheValuation";
        vaConsentEnum[vaConsentEnum["NotAwareOfTheValuation"] = 3] = "NotAwareOfTheValuation";
    })(srv.vaConsentEnum || (srv.vaConsentEnum = {}));
    var vaConsentEnum = srv.vaConsentEnum;
    (function (declarationsRaceEnum) {
        declarationsRaceEnum[declarationsRaceEnum["None"] = -1] = "None";
        declarationsRaceEnum[declarationsRaceEnum["DoNotWishToFurnishInformation"] = 0] = "DoNotWishToFurnishInformation";
        declarationsRaceEnum[declarationsRaceEnum["AmericanIndian"] = 1] = "AmericanIndian";
        declarationsRaceEnum[declarationsRaceEnum["Asian"] = 2] = "Asian";
        declarationsRaceEnum[declarationsRaceEnum["Black"] = 3] = "Black";
        declarationsRaceEnum[declarationsRaceEnum["NativeHawaiian"] = 4] = "NativeHawaiian";
        declarationsRaceEnum[declarationsRaceEnum["White"] = 5] = "White";
        declarationsRaceEnum[declarationsRaceEnum["NotApplicable"] = 6] = "NotApplicable";
    })(srv.declarationsRaceEnum || (srv.declarationsRaceEnum = {}));
    var declarationsRaceEnum = srv.declarationsRaceEnum;
    (function (borrowerDeclarationsIndicator) {
        borrowerDeclarationsIndicator[borrowerDeclarationsIndicator["UsCitizen"] = 0] = "UsCitizen";
        borrowerDeclarationsIndicator[borrowerDeclarationsIndicator["PermanentAlien"] = 1] = "PermanentAlien";
    })(srv.borrowerDeclarationsIndicator || (srv.borrowerDeclarationsIndicator = {}));
    var borrowerDeclarationsIndicator = srv.borrowerDeclarationsIndicator;
    var fhaConsentName = (function () {
        function fhaConsentName() {
        }
        fhaConsentName.SelectOne = 'Select One';
        fhaConsentName.AwareOfTheValuation = '(a) I was aware of this valuation when I signed my contract and I have paid or will pay in cash from my own resources at or prior to loan closing a sum equal to the difference between the contract purchase price or cost and the FHA established value. I do not and will not have outstanding after loan closing any unpaid contractual obligation on account of such cash payment;';
        fhaConsentName.NotAwareOfTheValuation = '(b) I was not aware of this valuation when I signed my contract but have elected to complete the transaction at the contract purchase price or cost. I have paid or will pay in cash from my own resources at or prior to loan closing a sum equal to the difference between contract purchase price or cost and the FHA established value. I do not and will not have outstanding after loan closing any unpaid contractual obligation on account of such cash payment';
        return fhaConsentName;
    })();
    srv.fhaConsentName = fhaConsentName;
    ...
    var folderName = (function () {
        ...
        folderName.DisclosuresComplianceCheck = 'Disclosures - Compliance Check';
    ...
    (function (milestoneStatus) {
        ...
        milestoneStatus[milestoneStatus["underwriting"] = 16] = "underwriting";
    ...
    (function (incomeTypeEnum) {
        ...
        incomeTypeEnum[incomeTypeEnum["automobileExpenseAcount"] = 9] = "automobileExpenseAcount";
        ...
        incomeTypeEnum[incomeTypeEnum["disablityIncome"] = 15] = "disablityIncome";
        incomeTypeEnum[incomeTypeEnum["selfEmployedIncome"] = 16] = "selfEmployedIncome";
        incomeTypeEnum[incomeTypeEnum["retirement"] = 17] = "retirement";
        incomeTypeEnum[incomeTypeEnum["unimployment"] = 27] = "unimployment";
