    ...
    var LoanApplicationViewModel = (function (_super) {
        ...
        function LoanApplicationViewModel(ti, loanApplication) {
           ...
           */
            ...
            */
            this.isLoanApplicationCompleted = function (subjectProperty, loanType, loanAmount, coBorrowerAddressDifferent, downPaymentTypeCode, isSixPieceCompletedForCurrentApp, purposeOfRefinance) {
                _this.isCompleted = _this.isPersonalCompleted() && _this.isPropertyCompleted(subjectProperty, loanType, loanAmount, coBorrowerAddressDifferent, purposeOfRefinance, downPaymentTypeCode) && _this.isAssetsCompleted() && _this.isCreditTabCompleted(isSixPieceCompletedForCurrentApp) && _this.isDeclarationsCompleted() && _this.isIncomeCompleted();
            ...
            */
            this.isPersonalCompleted = function () {
                if (!_this.validatePersonalCompletedForBorrower(_this.getBorrower()) || (_this.titleInfo.titleHeldIn == 0 && (common.string.isNullOrWhiteSpace(_this.titleInfo.namesOnTitle) || !(_this.titleInfo.mannerTitleHeld && _this.titleInfo.mannerTitleHeld != '-1'))) || (_this.getCoBorrower() && _this.isSpouseOnTheLoan && !_this.validatePersonalCompletedForBorrower(_this.getCoBorrower())) || (!_this.isSpouseOnTheLoan && _this.isSpouseOnTheTitle && _this.getBorrower().maritalStatus.toString() == '0' && (common.string.isNullOrWhiteSpace(_this.titleInfo.partnerFirstName) || common.string.isNullOrWhiteSpace(_this.titleInfo.partnerLastName))))
                    return false;
                return true;
            };
            /**
            ...
            */
            ...
            this.getSourcesOfOtherIncomeForGivenTypes = function (typesOfOtherIncomes, lookups) {
                var result = '';
                lib.forEach(_this.getSpecificOtherIncomeTypes(typesOfOtherIncomes), function (item) {
                    var source = lookups.getText(lookups.incomeTypesOther, String(item));
                    result += result.indexOf(source) == -1 ? source + ', ' : '';
                });
            ...
            this.getActiveDisclosureDetailsViewModel = function () {
                ...
                if (_this.disclosuresDetailsViewModel) {
                    lib.forEach(_this.disclosuresDetailsViewModel, function (disclosureDetail) {
            ...
            this.getSpecificOtherIncomeTypes = function (incomeTypes) {
                var specificOtherIncomeTypes = [];
                lib.forEach(incomeTypes, function (incomeTypeItem) {
                    lib.forEach(_this.getOtherIncomesCombined(), function (incomeItem) {
                        if (!!incomeItem.calculatedMonthlyAmount && incomeItem.incomeTypeId == incomeTypeItem) {
                            specificOtherIncomeTypes.push(incomeItem.incomeTypeId);
                        }
                    });
                });
                return specificOtherIncomeTypes;
            };
            this.getOtherIncomesCombined = function () {
                if (_this.isSpouseOnTheLoan) {
                    return _this.getBorrower().getOtherIncomes().concat(_this.getCoBorrower().getOtherIncomes());
                }
                else {
                    return _this.getBorrower().getOtherIncomes();
                }
            };
            /**
            ...
            */
            this.isPropertyCompleted = function (subjectProperty, loanType, loanAmount, coBorrowerAddressDifferent, purposeOfRefinance, downPaymentTypeCode) {
                var result;
                result = _this.isSubjectPropertySectionCompleted(subjectProperty, loanType, loanAmount, purposeOfRefinance, downPaymentTypeCode) && _this.isBorrowerCoBorrowerAddressSectionsCompleted(_this.getBorrower());
            ...
            */
            ...
            this.validateIncomePieceForBorrower = function (borrower) {
                ...
                if (!borrower.getCurrentEmploymentInfo())
                    return false;
                return borrower && borrower.getCurrentEmploymentInfo() && borrower.getCurrentEmploymentInfo().getIncomeInformation() && borrower.getCurrentEmploymentInfo().getIncomeInformation().length > 0 && (borrower.getCurrentEmploymentInfo().EmploymentTypeId == 0 /* ActiveMilitaryDuty */ && borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(11 /* MilitaryBasePay */) && borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(11 /* MilitaryBasePay */).amount != 0) || (borrower.getCurrentEmploymentInfo().EmploymentTypeId == 2 /* SelfEmployed */ && (borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(16 /* SelfEmployedIncome */) && borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(16 /* SelfEmployedIncome */).amount != 0 || borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(13 /* PartTime */) && borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(13 /* PartTime */).amount != 0 || borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(3 /* Commissions */) && borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(3 /* Commissions */).amount != 0)) || (borrower.getCurrentEmploymentInfo().EmploymentTypeId == 1 /* SalariedEmployee */ && ((borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(0 /* BaseEmployment */) && borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(0 /* BaseEmployment */).amount != 0) || (borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(13 /* PartTime */) && borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(13 /* PartTime */).amount != 0) || (borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(3 /* Commissions */) && borrower.getCurrentEmploymentInfo().incomeInfoByTypeId(3 /* Commissions */).amount != 0))) || ((borrower.getCurrentEmploymentInfo().EmploymentTypeId == 3 /* Retired */) && hasOtherIncomes) || (borrower.getCurrentEmploymentInfo().EmploymentTypeId == 4 /* OtherUnemployed */);
            };
            ...
            */
            this.isBorrowerCoBorrowerAddressSectionsCompleted = function (borrower) {
                ...
                if (borrower.getCurrentAddress().timeAtAddressYears < 2) {
                    ...
                    result = result && previousAddress.isValid() && borrower.getPreviousAddress().isOwnershipValid();
                }
                return result;
            };
            /**
            ...
            */
            this.isSubjectPropertySectionCompleted = function (subjectProperty, loanType, loanAmount, purposeOfRefinance, downPaymentTypeCode) {
                var result;
                //
                ...
                if (!subjectProperty)
                    return false;
                result = (!common.string.isNullOrWhiteSpace(subjectProperty.cityName) && !common.string.isNullOrWhiteSpace(subjectProperty.countyName) && !common.string.isNullOrWhiteSpace(subjectProperty.stateName) && !common.string.isNullOrWhiteSpace(subjectProperty.streetName) && !common.string.isNullOrWhiteSpace(subjectProperty.zipCode) && subjectProperty.purchasePrice > 0 && loanAmount > 0 && subjectProperty.propertyType != "0" && subjectProperty.numberOfUnits != 0 && _this.occupancyType != 0 /* None */);
                if (+subjectProperty.propertyType == 2 /* Condominium */)
                    result = result && subjectProperty.numberOfStories > 0;
                if (loanType === 1 /* Purchase */) {
                    result = result && subjectProperty.downPayment >= 0 && !!downPaymentTypeCode && subjectProperty.monthlyHOAdues >= 0;
                    ...
                    result = result && subjectProperty.purchaseDate && (subjectProperty.currentEstimatedValue > 0 && subjectProperty.purchaseDate != null) && !!purposeOfRefinance;
                }
                if (!(subjectProperty.lotSizeInAcres && subjectProperty.sizeOfHomeSqFeet)) {
                    if (common.string.isNullOrWhiteSpace(subjectProperty.stateName)) {
                        return result = false;
                    }
                    if (loanType == 1 /* Purchase */ && (!!(["FL", "HI", "NM", "TX"].indexOf(subjectProperty.stateName) + 1))) {
                        result = false;
                    }
                    if (loanType == 2 /* Refinance */ && (!!(["FL", "NM", "TX"].indexOf(subjectProperty.stateName) + 1))) {
                        result = false;
                    }
                }
                return result;
            ...
            */
            ...
            this.borrowerHasChildAlimony = function () {
                return _this.getMiscDebtsForBorrower(_this.getBorrower()).filter(function (item) {
                    return item.typeId == 1 /* ChildCareExpensesForVALoansOnly */ && (item.amount != 0 || !common.string.isNullOrWhiteSpace(item.payee)) && !item.isRemoved;
                }).length > 0;
            };
       ...
       */
        ...
        Object.defineProperty(LoanApplicationViewModel.prototype, "addressEffectiveBorrowerCurrent", {
            //moved from propertycontroller.ts
            get: function () {
                var addr;
                if (this.borrowerCurrentAddressIsSameAsPropertyAddress)
                    addr = this.getTransactionInfo().getLoan().getSubjectProperty();
                else
                    addr = this.getBorrower().getCurrentAddress();
                return addr;
            },
            set: function (addr) {
                /* Read-Only */
        ...
        Object.defineProperty(LoanApplicationViewModel.prototype, "addressEffectiveBorrowerMailing", {
            get: function () {
                var addr;
                if (!this.borrowerMailingAddressIsDifferentFromCurrentAddress)
                    addr = this.addressEffectiveBorrowerCurrent;
                else
                    addr = this.getBorrower().getMailingAddress();
                return addr;
            },
            set: function (addr) {
                /* Read-Only */
        ...
        Object.defineProperty(LoanApplicationViewModel.prototype, "borrowerCurrentAddressIsSameAsPropertyAddressIsDisabled", {
            get: function () {
                var loanVm = this;
                return this.loanPurposeType == 2 /* Refinance */ && this.getTransactionInfo().getLoan().getSubjectProperty().OccupancyType == 1 /* PrimaryResidence */;
            },
        ...
        Object.defineProperty(LoanApplicationViewModel.prototype, "borrowerCurrentAddressIsSameAsPropertyAddress", {
            get: function () {
                if (this.borrowerCurrentAddressIsSameAsPropertyAddressIsDisabled) {
                    // Always true in this case , assign and and return [true]
                    return this.getBorrower().getCurrentAddress().isSameAsPropertyAddress = true;
                }
                else {
                    return this.getBorrower().getCurrentAddress().isSameAsPropertyAddress;
                }
            },
            set: function (areSame) {
                this.toggleAddressIsSameAs(this.getBorrower().getCurrentAddress(), this.gsSubj, areSame);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(LoanApplicationViewModel.prototype, "borrowerMailingAddressIsDifferentFromCurrentAddress", {
            get: function () {
                var areSame = this.getBorrower().getMailingAddress().isSameMailingAsBorrowerCurrentAddress;
                return !areSame;
            },
            set: function (areDifferent) {
                this.toggleAddressIsSameAs(this.getBorrower().getMailingAddress(), this.gsMail, !areDifferent);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(LoanApplicationViewModel.prototype, "addressEffectiveCoBorrowerCurrent", {
            get: function () {
                var addr;
                if (this.coBorrowerCurrentAddressIsDifferentFromBorrower)
                    addr = this.getCoBorrower().getCurrentAddress();
                else
                    addr = this.addressEffectiveBorrowerCurrent;
                return addr;
            },
        ...
        Object.defineProperty(LoanApplicationViewModel.prototype, "complianceCheckFailed", {
            get: function () {
                return (this.complianceCheckStatus == 2 /* Failed */) || (this.complianceCheckErrors && this.complianceCheckErrors.length > 0 && this.complianceCheckStatus == 3 /* InProgress */);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(LoanApplicationViewModel.prototype, "disclosureCheckFailed", {
            get: function () {
                //TODO: check disclosure errors
                return (this.disclosureStatusDetails && this.disclosureStatusDetails.disclosureStatus == 6 /* DisclosuresFailed */) || (this.disclosureErrors && this.disclosureErrors.length > 0 && this.disclosureStatusDetails && this.disclosureStatusDetails.disclosureStatus == 4 /* RequestInProgress */);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(LoanApplicationViewModel.prototype, "addressEffectiveCoBorrowerMailing", {
            get: function () {
                var addr;
                if (!this.coBorrowerMailingAddressIsDifferentFromCurrentAddress)
                    addr = this.addressEffectiveCoBorrowerCurrent;
                else
                    addr = this.getCoBorrower().getMailingAddress();
                return addr;
            },
            set: function (addr) {
                /* Read-Only */
        ...
        Object.defineProperty(LoanApplicationViewModel.prototype, "coBorrowerCurrentAddressIsDifferentFromBorrower", {
            get: function () {
                // @todo-cl: Consider a conjunction with [this.wrappedLoan.ref.active.isSpouseOnTheLoan] as well
                var areSame = this.getCoBorrower().getCurrentAddress().isSameAsPrimaryBorrowerCurrentAddress;
                return !areSame;
            },
            set: function (areDifferent) {
                this.toggleAddressIsSameAs(this.getCoBorrower().getCurrentAddress(), this.gsPrim, !areDifferent);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(LoanApplicationViewModel.prototype, "coBorrowerMailingAddressIsDifferentFromCurrentAddress", {
            get: function () {
                var areSame = this.getCoBorrower().getMailingAddress().isSameMailingAsBorrowerCurrentAddress;
                return !areSame;
            },
            set: function (areDifferent) {
                this.toggleAddressIsSameAs(this.getCoBorrower().getMailingAddress(), this.gsMail, !areDifferent);
            },
            enumerable: true,
            configurable: true
        });
