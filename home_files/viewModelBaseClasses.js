...
(function (srv) {
    ...
    (function (cls) {
        ...
        var OpEnvelopeBase = (function () {
            function OpEnvelopeBase() {
            }
            return OpEnvelopeBase;
        })();
        cls.OpEnvelopeBase = OpEnvelopeBase;
        var ResponseEnvelopeBase = (function () {
            function ResponseEnvelopeBase() {
            }
            return ResponseEnvelopeBase;
        })();
        cls.ResponseEnvelopeBase = ResponseEnvelopeBase;
