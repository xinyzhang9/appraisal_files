...
(function (consumersite) {
    var FilePickerController = (function () {
        function FilePickerController(enums, $modalInstance, templateRoot) {
            var _this = this;
            this.enums = enums;
            ...
            // Todo - Set this up as a directive.  File Chooser.
            // Fixes.  Bug with HTML input type = file
            this.fileChooserClick = function () {
                // $("#fileChooser").attr("value", "");
                $("#fileChooser").val("");
                // $("#fileChooserXS").attr("value", "");
                $("#fileChooserXS").val("");
            };
        ...
        FilePickerController.$inject = ['enums', '$modalInstance', 'templateRoot'];
