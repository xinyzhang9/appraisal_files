...
(function (cls) {
    ...
    var LookupViewModel = (function (_super) {
        ...
        function LookupViewModel(lookupVm) {
            ...
            this.initializePropertyTypes = function () {
                lib.forEach(_this.subjectPropertyTypes, function (item) {
                    if (item.contextFlags != null) {
                        item.value = item.value + '.' + item.contextFlags;
                    }
                });
            };
            //
            ...
            this.getDescription = function (lookups, value) {
                var retVal = "";
                lib.forEach(lookups, function (e) {
                    if (e.value == value) {
            ...
            this.getText = function (lookups, value) {
                var retVal = "";
                lib.forEach(lookups, function (e) {
                    if (e.value == value) {
                        retVal = e.text;
