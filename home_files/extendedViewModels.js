...
(function (cls) {
    ...
    var SecureLinkEmailViewModel = (function (_super) {
        __extends(SecureLinkEmailViewModel, _super);
        function SecureLinkEmailViewModel(secureLinkEmail) {
            _super.call(this);
            if (secureLinkEmail) {
                common.objects.automap(this, secureLinkEmail);
            }
        }
        return SecureLinkEmailViewModel;
    })(srv.cls.SecureLinkEmailViewModel);
    ...
    var HouseholdMemberIncomeAndDeductionsViewModel = (function (_super) {
        __extends(HouseholdMemberIncomeAndDeductionsViewModel, _super);
        function HouseholdMemberIncomeAndDeductionsViewModel(householdMemberIncomeAndDeductions, householdTitleType, householdType, amount, description) {
            _super.call(this);
            if (householdMemberIncomeAndDeductions) {
                common.objects.automap(this, householdMemberIncomeAndDeductions);
            }
            if (householdTitleType) {
                this.householdTitleType = householdTitleType;
            }
            if (householdType) {
    ...
    })(srv.cls.HouseholdMemberIncomeAndDeductionsViewModel);
    ...
    var DeclarationInfoViewModel = (function (_super) {
        ...
        function DeclarationInfoViewModel(declarationInfo) {
            ...
            if (!this.race)
                this.race = new cls.RaceViewModel();
            else {
                this.race = new cls.RaceViewModel(this.race);
            }
        }
        return DeclarationInfoViewModel;
    })(srv.cls.DeclarationInfoViewModel);
    cls.DeclarationInfoViewModel = DeclarationInfoViewModel;
    var RaceViewModel = (function (_super) {
        __extends(RaceViewModel, _super);
        function RaceViewModel(raceInfo) {
            _super.call(this);
            if (raceInfo) {
                common.objects.automap(this, raceInfo);
            }
        }
        return RaceViewModel;
    })(srv.cls.RaceViewModel);
    ...
    var LookupItem = (function (_super) {
        ...
        function LookupItem(text, value, description) {
            _super.call(this);
            this.text = text;
            this.value = value;
            this.description = description;
        ...
        LookupItem.fromLookupItem = function (src) {
            var li = new LookupItem(src.text, src.value, src.description);
    ...
    var PricingAdjustmentsViewModel = (function (_super) {
        ...
        function PricingAdjustmentsViewModel(pricingAdjustments, lockingModel, financialInfo) {
            _super.call(this);
            if (pricingAdjustments) {
                common.objects.automap(this, pricingAdjustments);
            }
            if (lockingModel) {
                this._loanLockViewModel = lockingModel;
            }
            if (financialInfo) {
                this._financialInfo = financialInfo;
                // Base Interest Rate(Investor Rate) is returned by OB and it represents Enterprise Base Rate
                // For POS, the Enterprise Rate is calculated as follows: Enterprise Base Rate
                this.EnterpriseBaseRate = financialInfo.baseInterestRate;
            }
        }
        ...
        Object.defineProperty(PricingAdjustmentsViewModel.prototype, "EnterpriseBaseRate", {
            get: function () {
                return this.enterpriseBaseRate;
            },
            set: function (value) {
                this.enterpriseBaseRate = (!this.isAmountValid(value)) ? 0 : value;
                this._loanLockViewModel.investorRate = this.enterpriseBaseRate;
                // For POS Enterprise Rate is Enterprise Base Rate
                this.EnterpriseRate = this.enterpriseBaseRate;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(PricingAdjustmentsViewModel.prototype, "EnterpriseRate", {
            get: function () {
                return this.enterpriseRate;
            },
            set: function (value) {
                this.enterpriseRate = (!this.isAmountValid(value)) ? 0 : value;
                this._loanLockViewModel.enterpriceRate = this.enterpriseRate;
                // For POS EntepriseRate is LoanOfficerBaseRate
                this.LoanOfficerBaseRate = this.enterpriseRate;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(PricingAdjustmentsViewModel.prototype, "LoanOfficerBaseRate", {
            get: function () {
                return this.loanOfficerBaseRate;
            },
            set: function (value) {
                this.loanOfficerBaseRate = (!this.isAmountValid(value)) ? 0 : value;
                this._loanLockViewModel.loanOfficerRate = this.loanOfficerBaseRate;
                //For POS LoanOfficerBaseRate is FinalLoanOfficerRate
                this.FinalLoanOfficerRate = this.loanOfficerBaseRate;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(PricingAdjustmentsViewModel.prototype, "FinalLoanOfficerRate", {
            get: function () {
                return this.finalLoanOfficerRate;
            },
            set: function (value) {
                // For POS FinalLoanOfficerRate is LoanOfficerBaseRate
                this.finalLoanOfficerRate = (!this.isAmountValid(value)) ? 0 : value;
                this._loanLockViewModel.finalLoanOfficerRate = this.finalLoanOfficerRate;
            },
            enumerable: true,
            configurable: true
        });
                ...
                for (var i = 0; i < len; i++) {
                    if (this.adjustments[i].adjustmentSectionType == secType) {
                        if (!this.adjustments[i].isDeleted) {
                            if (this.adjustments[i].adjustmentTypeId != 2 /* Sec2Concession */ || (this.adjustments[i].adjustmentTypeId == 2 /* Sec2Concession */ && this.adjustments[i].description == "Approved")) {
    ...
    var MilestoneStatus = (function () {
        function MilestoneStatus() {
            var _this = this;
            this.setDefault = function (isWholeSale, homebuyingType, isCreditRetrievedForAllLoanApplications, loanPurpose) {
                //preApproval
                if (homebuyingType == 3 /* GetPreApproved */ && loanPurpose == 1 /* Purchase */ && isCreditRetrievedForAllLoanApplications)
            ...
            this.setStatus = function (isWholeSale, allLoanAppsCompleted, sixPiecesAcquired, homeBuyingType, isCreditRetrievedForAllLoanApplications, loanPurpose) {
                if (sixPiecesAcquired) {
                    ...
                    return _this.setDefault(isWholeSale, homeBuyingType, isCreditRetrievedForAllLoanApplications, loanPurpose);
                }
            };
        }
    ...
    var USDACalculatorRequest = (function (_super) {
        __extends(USDACalculatorRequest, _super);
        function USDACalculatorRequest(annualChildCareExpenses, annualDisabilityExpenses, annualMedicalExpenses, borrowerCurrentEmploymentIncomes, borrowerOtherIncomes, coBorrowerCurrentEmploymentIncomes, coBorrowerOtherIncomes, householdMembers, moderateIncomeLimit) {
            _super.call(this);
            this.annualChildCareExpenses = annualChildCareExpenses;
            this.annualDisabilityExpenses = annualDisabilityExpenses;
            this.annualMedicalExpenses = annualMedicalExpenses;
            this.borrowerCurrentEmploymentIncomes = borrowerCurrentEmploymentIncomes;
            this.borrowerOtherIncomes = borrowerOtherIncomes;
            this.coBorrowerCurrentEmploymentIncomes = coBorrowerCurrentEmploymentIncomes;
            this.coBorrowerOtherIncomes = coBorrowerOtherIncomes;
            this.householdMembers = householdMembers;
            this.moderateIncomeLimit = moderateIncomeLimit;
        }
        return USDACalculatorRequest;
    })(srv.cls.USDACalculatorRequest);
    cls.USDACalculatorRequest = USDACalculatorRequest;
    var FHAScenarioViewModel = (function (_super) {
        __extends(FHAScenarioViewModel, _super);
        function FHAScenarioViewModel(ti, fhaScenario) {
            _super.call(this);
            this.ti = ti;
            lib.copyState(fhaScenario, this);
            if (!this.minDownPaymentApprovedByHud) {
                this.minDownPaymentApprovedByHud = 100;
            }
        }
        Object.defineProperty(FHAScenarioViewModel.prototype, "PurchasePrice", {
            get: function () {
                return this.purchasePrice = !!this.purchasePrice ? this.purchasePrice : this.ti.getLoan().getSubjectProperty().purchasePrice;
            },
            set: function (value) {
        ...
        Object.defineProperty(FHAScenarioViewModel.prototype, "PurchasePriceWithDocumentedImprovements", {
            get: function () {
                return this.purchasePriceWithDocumentedImprovements = !!this.purchasePriceWithDocumentedImprovements ? this.purchasePriceWithDocumentedImprovements : this.ti.getLoan().getSubjectProperty().purchasePrice;
            },
            set: function (value) {
                this.purchasePriceWithDocumentedImprovements = value;
            },
            enumerable: true,
            configurable: true
        });
        return FHAScenarioViewModel;
    })(srv.cls.FHAScenarioViewModel);
    cls.FHAScenarioViewModel = FHAScenarioViewModel;
    var VAInformarionViewModel = (function (_super) {
        __extends(VAInformarionViewModel, _super);
        function VAInformarionViewModel(ti, vaInformation) {
            _super.call(this);
            this.ti = ti;
            if (!!vaInformation) {
                lib.copyState(vaInformation, this);
            }
        }
        Object.defineProperty(VAInformarionViewModel.prototype, "ExistingVaBalance", {
            get: function () {
                this.liabilities = this.ti.getLoan().primary.getBorrower().getLiabilities().concat(this.ti.getLoan().primary.getCoBorrower().getLiabilities());
                this.firstMortgage = lib.findFirst(this.liabilities, function (l) {
                    return l.property && l.property.isSubjectProperty && l.isPledged && l.lienPosition == 1;
                });
                if (this.firstMortgage) {
                    return this.firstMortgage.unpaidBalance;
                }
                else {
                    return this.ti.getLoan().otherInterviewData.firstMortgage;
                }
            },
            set: function (value) {
                if (this.firstMortgage) {
                    this.firstMortgage.unpaidBalance = value;
                }
                this.ti.getLoan().otherInterviewData.firstMortgage = value;
            },
            enumerable: true,
            configurable: true
        });
        return VAInformarionViewModel;
    })(srv.cls.VAInformationViewModel);
    cls.VAInformarionViewModel = VAInformarionViewModel;
    var VACalculatorRequestViewModel = (function (_super) {
        __extends(VACalculatorRequestViewModel, _super);
        function VACalculatorRequestViewModel(existingVALoanBalance, eehiCosts, veteranPaymentCash, discountPoints, originationFee, vaFundingFeeFactor, totalClosingCosts, baseLoanAmount, allowableClosingCostsAndPrepaids) {
            _super.call(this);
            ...
            this.vaFundingFeeFactor = vaFundingFeeFactor;
            this.totalClosingCosts = totalClosingCosts;
            this.baseLoanAmount = baseLoanAmount;
            this.allowableClosingCostsAndPrepaids = allowableClosingCostsAndPrepaids;
        }
    ...
    var HouseholdMemberViewModel = (function (_super) {
        __extends(HouseholdMemberViewModel, _super);
        function HouseholdMemberViewModel(ti, householdMemberViewModel, householdMemberType, fullTimeStudent, disabled, age, borrowerId, fullName, householdMemberId, incomeAmount, loanId, source, fieldsDisabled, order, isUserEntry) {
            _super.call(this);
            this.ti = ti;
            this.fieldsDisabled = fieldsDisabled;
            this.order = order;
            this.isUserEntry = isUserEntry;
            if (householdMemberViewModel) {
                common.objects.automap(this, householdMemberViewModel);
            }
            else {
            ...
            this.order = order;
            this.isUserEntry = isUserEntry;
            switch (this.householdMemberType) {
                case 1 /* Borrower */:
                ...
                case 2 /* CoBorrower */:
                    ...
                    break;
                default:
                    this.householdMemberType = 3 /* Household */;
                    this.fieldsDisabled = false;
                    this.order = 3;
                    break;
            }
        }
        Object.defineProperty(HouseholdMemberViewModel.prototype, "FullName", {
            get: function () {
                var self = this;
                var borrower = lib.findFirst(this.ti.borrowers, function (item) {
                    return item.borrowerId.toLowerCase() === (self.borrowerId != null ? self.borrowerId.toLowerCase() : '');
                });
                if (borrower != null) {
        ...
        Object.defineProperty(HouseholdMemberViewModel.prototype, "Age", {
            get: function () {
                var self = this;
                var borrower = lib.findFirst(this.ti.borrowers, function (item) {
                    return item.borrowerId.toLowerCase() === (self.borrowerId != null ? self.borrowerId.toLowerCase() : '');
                ...
                if (borrower != null)
                    this.age = lib.getYearsOutOfDate(borrower.dateOfBirth);
                return this.age;
            },
            set: function (value) {
                this.age = value;
    ...
    })(srv.cls.HouseholdMemberViewModel);
