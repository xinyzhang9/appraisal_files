...
(function () {
    ...
    angular.module('simpleModalWindow').run(function ($templateCache, $http, templateRoot) {
        $http.get(templateRoot + 'common/simplemodalwindow/simplemodalwindow.errorsave.html', { cache: $templateCache });
    });
})();
