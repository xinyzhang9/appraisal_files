    ...
    var LiabilityViewModel = (function (_super) {
        ...
        function LiabilityViewModel(ti, liability, borrowerFullName) {
            ...
            this.isValid = function () {
                if (_this.borrowerDebtCommentId != 6 /* NotMyLoan */) {
                    ...
                    if (_this.borrowerDebtCommentId != 1 /* PaidOffFreeAndClear */) {
                        if (!_this.lienPosition || !_this.companyData.companyName || !_this.isMinPaymentValid() || !_this.isUnpaidBalanceValid() || (_this.pledgedAssetLoanType == 2 /* Heloc */ && !_this.maximumCreditLine) || (_this.lienPosition == 1 /* First */ && !_this.getProperty().areExpensesValid()) || (_this.getProperty().isSubjectProperty && _this.lienPosition == 1 /* First */ && (_this.reoInfo.sameServicer == null || _this.reoInfo.sameServicer == undefined)))
                            return false;
                    }
                }
                return true;
            ...
            */
            ...
            this.isMinPaymentValid = function () {
                return _this.pledgedAssetLoanType == 2 /* Heloc */ || _this.minPayment;
            };
            this.isUnpaidBalanceValid = function () {
                return _this.pledgedAssetLoanType == 2 /* Heloc */ || _this.unpaidBalance;
            };
            if (!!liability) {
