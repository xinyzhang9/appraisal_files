    ...
    var TransactionInfo = (function () {
        function TransactionInfo() {
            ...
            this.prepareSave = function () {
                ...
                if (_this.property) {
                    lib.conditionalForEach(_this.property.getValues(), function (o) { return (o.addressTypeId == 2 && o.fullAddress != ""); }, function (property) { return property.loanId = loan.loanId; });
