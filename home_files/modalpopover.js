(function () {
    ...
    function modalPopoverFactory($modalpopover) {
        ...
        function openModalPopover(templateUrl, extCtrl, extModel, event, modalOptions, staticItems) {
            ...
            return $modalpopover.open({
                ...
                resolve: resolve(extCtrl, extModel, modalOptions.refExtModelAndCtrl, staticItems),
        ...
        function resolve(extCtrl, extModel, refExtModelAndCtrl, staticItems) {
            var resolve = {
                intCtrl: function () {
                    return extCtrl;
                },
        ...
        function modalpopoverCtrl(intCtrl, inModel, refExtModelAndCtrl, $modalInstance, staticItems) {
            var self = this;
