...
(function (consumersite) {
    var AdditionalBorrowerController = (function () {
        function AdditionalBorrowerController(loan, loanAppPageContext, applicationData, templateRoot) {
            this.loan = loan;
        ...
        AdditionalBorrowerController.$inject = ['loan', 'loanAppPageContext', 'applicationData', 'templateRoot'];
