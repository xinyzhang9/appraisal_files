...
(function (util) {
    ...
    var addressWidget = (function () {
        ...
        function addressWidget(ZipCodeSvc, templateRoot) {
            var _this = this;
            ...
            this.fetchZipData = function ($scope, ZipCodeSvc) {
                try {
                    _this.fetchZipDataImpl($scope, ZipCodeSvc);
                }
                catch (e) {
                    console.error(e);
                }
            };
            this.fetchZipDataImpl = function ($scope, ZipCodeSvc) {
            ...
            **/
            ...
            this.controller = function ($scope) {
                ...
                if ($scope.stateName)
                    _this.SetStateId($scope);
                if (!$scope.contentUrl)
                    $scope.contentUrl = 'common/address/address.html';
                if (!$scope.contentUrl.toLowerCase().startsWith(_this.templateRoot.toLowerCase())) {
                    $scope.contentUrl = _this.templateRoot + $scope.contentUrl;
                }
        ...
        **/
        addressWidget.Factory = function () {
            var directive = function (ZipCodeSvc, templateRoot) {
                return new addressWidget(ZipCodeSvc, templateRoot);
            };
            directive['$inject'] = ['ZipCodeSvc', 'templateRoot'];
            return directive;
        };
