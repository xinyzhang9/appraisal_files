(function () {
    ...
    var enums = {
        ...
        privileges: {
            ...
            ViewPricingXML: "View Pricing XML",
            ...
            EditMortgageInsuranceDetail: "Edit Mortgage Insurance Detail",
            NtbChangeCalculated: "Change NTB calculated values",
            DeleteConcession: "Delete Concession",
            RequestConcession: "Request Concession",
            EditCoBorrowerMaritalStatus: "Edit Co-Borrower Marital Status",
            ViewClosingCorpXML: "View Closing Corp XML"
        },
        housingExpenses: {
            homeOwnerExpense: 1,
        ...
        loanOriginatorSource: {
            ...
            telephoneInterview: 1,
            faxOrEmailInterview: 2,
            emailOrInternetInterview: 3
        },
        sexType: {
            none: -1,
            female: 0,
            male: 1,
            iDoNotWishToFurnishThisInformation: 2,
            notApplicable: 3        
        },
        ethnicityType: {
            none: -1,
            notHispanicOrLatino: 0,
            hispanicOrLatino: 1,
            iDoNotWishToFurnishThisInformation: 2,
            notApplicable: 3
        },
        ...
        loanTypeEnum : {
            ...
            FHA: "FHA",
            USDA: "USDA",
            HARP_FannieMae: "HARP_FannieMae",
            HARP_FreddieMac: "HARP_FreddieMac"
        },
    ...
    var loanPricingAdjustmentTypes = [
        { name: 'LLPA', value: 1 },
        { name: 'Concession', value: 2 },
        { name: 'Excess Pricing', value: 3 },
        { name: 'Extension', value: 4 },
        { name: 'Renegotiation', value: 5 },
        { name: 'Worst-Case Pricing', value: 6 },
        { name: 'Corporate Margin', value: 7 },
        { name: 'Division Margin', value: 8 },
        { name: 'Loan Officer Compensation', value: 9 },
        { name: 'Excess Pricing', value: 10 },
        { name: 'Extension', value: 11 },
        { name: 'Excess Pricing', value: 12 },
        { name: 'Extension', value: 13 },
        { name: 'Renegotiation', value: 14 },
        { name: 'Worst-Case Pricing', value: 15 },
        { name: 'Company Margin', value: 16 },
        { name: 'Compensation', value: 17 },
        { name: 'IPA', value: 18 },
        { name: 'IRA', value: 19 },
        { name: 'LLRA', value: 20 },
        { name: 'IPA', value: 21 },
    ...
    angular.module('util')
        ...
        .constant('loanPricingAdjustmentTypes', loanPricingAdjustmentTypes);
    //.constant('pi', 3.14);
