...
(function (cls) {
    ...
    var EmploymentInfoViewModel = (function (_super) {
        ...
        function EmploymentInfoViewModel(ti, employmentInfo) {
            ...
            this.validateSelfOrSalariedEmployee = function () {
                ...
                var commisionIncome = _this.incomeInfoByTypeId(3);
                var retVal = _this.validateJointRules() && (basePay && basePay.amount || partTime && partTime.amount || commisionIncome && commisionIncome.amount) && !common.string.isNullOrWhiteSpace(_this.name) && !common.string.isNullOrWhiteSpace(_this.typeOfBusiness);
    ...
    var AdditionalEmploymentInfoViewModel = (function (_super) {
        ...
        function AdditionalEmploymentInfoViewModel(ti, additionalEmploymentInfo, isPrevious) {
            ...
            if (angular.isDefined(isPrevious)) {
                if (isPrevious)
